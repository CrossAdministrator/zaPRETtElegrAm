...
# <img src="https://cdn-icons-png.flaticon.com/128/5968/5968756.png" height=28 /> <a href="https://github.com/CrossAdministrator/">CrossAdministrator</a><a href="https://github.com/CrossAdministrator/zaPRETtElegrAm">/zaPRETtElegrAm</a> <img src="https://cdn-icons-png.flaticon.com/128/1384/1384060.png" height=28 />
...
<!-- gbzap-pages-link -->
**Страница сборки:** [https://crossadministrator.github.io/zaPRETtElegrAm/](https://crossadministrator.github.io/zaPRETtElegrAm/)

> [!CAUTION]
>
> ### ФЕЙКИ
> Я не веду никакие другие страницы/группы в телеграм/ютуб каналы  
> Если вы наткнулись на что-то вне репозитория `CrossAdministrator/zaPRETtElegrAm`, что распространяется от моего лица - **ФЕЙК**.
...
2. Скачайте архив (zip/rar) со [страницы последнего релиза](https://github.com/CrossAdministrator/zaPRETtElegrAm/releases/latest)
...
Если этого не произошло, то см. [#522](https://github.com/CrossAdministrator/zaPRETtElegrAm/issues/522)
...
- См. [#765](https://github.com/CrossAdministrator/zaPRETtElegrAm/issues/765)
...
- Скачайте последнюю версию [со страницы релизов](https://github.com/CrossAdministrator/zaPRETtElegrAm/releases/latest) (`zapret-discord-youtube-...`)
...
- См. также [#251](https://github.com/CrossAdministrator/zaPRETtElegrAm/discussions/251)
...
- См. также [#252](https://github.com/CrossAdministrator/zaPRETtElegrAm/discussions/252)
...
Если и это не помогло, создайте ветку обсуждений в разделе [Discussions](https://github.com/CrossAdministrator/zaPRETtElegrAm/discussions) (не в issues) и ждите помощи от других игроков.

### Не нашли своей проблемы

- Создайте её [тут](https://github.com/CrossAdministrator/zaPRETtElegrAm/issues)
...
Проект распространяется на условиях лицензии [MIT](https://github.com/CrossAdministrator/zaPRETtElegrAm/blob/main/LICENSE.txt)

## 🩷Благодарность участникам проекта

](https://github.com/CrossAdministrator/zaPRETtElegrAm/graphs/contributors)
